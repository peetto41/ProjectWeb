    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">อัพเดทหนังมาใหม่!!!</h1>
          </div>    
          ...
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img class="d-block w-100" src="img/captain_marvel.jpg" alt="First slide" height="600" width="600">
            </div>
            <div class="carousel-item">
              <img class="d-block w-100" src="img/Marvel.jpg" alt="Second slide" height="600" width="600">
            </div>
            <div class="carousel-item">
              <img class="d-block w-100" src="img/eternals.jpg" alt="Third slide"height="600" width="600"> 
            </div>
          </div>
          ...
          <div class="card-deck">
          <div class="card">
            <img class="card-img-top" src="img/avge.jpeg" alt="Card image cap"height="500">
            <div class="card-body">
              <h5 class="card-title" href="charts.html">Avenger EndGame</h5>
              <a href="index.jsp" class="btn btn-danger stretched-link">รับชมภาพยนตร์</a>
            </div>
          </div>
          <div class="card">
            <img class="card-img-top" src="img/cap.jpeg" alt="Card image cap"height="500">
            <div class="card-body">
          ...
          <div class="card">
            <img class="card-img-top" src="..." alt="Card image cap"height="500">
            <div class="card-body">
